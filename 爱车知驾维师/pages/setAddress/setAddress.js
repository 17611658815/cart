...
Page({
        ...
        wx.getSystemInfo({
            success: (res) => {
               ...
               that.setData({
                   ...
                   city: wx.getStorageSync('city'),//当前城市
            ...
            success: function (res) {
                wx.request({
                    ...
                    success: function (e) {
                        ...
                        app.setTitle(e.data.result.address_component.city)
                        that.setData({
    ...
    getcityInfo(latitude, longitude){
        let that = this;
        wx.request({
            url: 'https://apis.map.qq.com/ws/geocoder/v1/?location=' + latitude + ',' + longitude + '&key=UYFBZ-ANUWW-Y7GRO-OURNR-G5L7O-PHFMD',
            success: function (e) {
                console.log(e)
                app.globalData.longitude = longitude;
                app.globalData.latitude = latitude;
                app.globalData.city = e.data.result.address_component.city
                app.setStorage("longitude", longitude)
                app.setStorage("latitude", latitude)
    ...
    onLocation(e){
        ...
        that.getcityInfo(e.detail.latitude, e.detail.longitude)
    },
    // 选择附近位置
    selectAddres(res) {
        let that = this;
